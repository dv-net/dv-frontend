...
> = {
	"ARB.Arbitrum": { precision: 18, depositTime: 2, confirmations: 20 },
	"CAKE.Arbitrum": { precision: 18, depositTime: 2, confirmations: 20 },
	"DAI.Arbitrum": { precision: 2, depositTime: 2, confirmations: 20 },
	"ETH.Arbitrum": { precision: 8, depositTime: 2, confirmations: 20 },
	"PYUSD.Arbitrum": { precision: 6, depositTime: 2, confirmations: 20 },
	...
	"BNB.BNBSmartChain": { precision: 8, depositTime: 2, confirmations: 20 },
	"CAKE.BNBSmartChain": { precision: 18, depositTime: 2, confirmations: 20 },
	"DAI.BNBSmartChain": { precision: 8, depositTime: 2, confirmations: 20 },
	"SHIB.BNBSmartChain": { precision: 18, depositTime: 2, confirmations: 20 },
	"USD1.BNBSmartChain": { precision: 18, depositTime: 2, confirmations: 20 },
	"USDC.BNBSmartChain": { precision: 8, depositTime: 2, confirmations: 20 },
	"USDD.BNBSmartChain": { precision: 18, depositTime: 2, confirmations: 20 },
	"USDE.BNBSmartChain": { precision: 18, depositTime: 2, confirmations: 20 },
	"USDT.BNBSmartChain": { precision: 8, depositTime: 2, confirmations: 20 },
	"WLFI.BNBSmartChain": { precision: 18, depositTime: 2, confirmations: 20 },
	"DOGE.Dogecoin": { precision: 8, depositTime: 1, confirmations: 1 },
	"ARB.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"CAKE.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"DAI.Ethereum": { precision: 2, depositTime: 2, confirmations: 12 },
	"ENA.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"ETH.Ethereum": { precision: 6, depositTime: 3, confirmations: 12 },
	"PEPE.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"PYUSD.Ethereum": { precision: 6, depositTime: 2, confirmations: 12 },
	"SAND.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"SHIB.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"USD1.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"USDC.Ethereum": { precision: 2, depositTime: 2, confirmations: 12 },
	"USDD.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"USDE.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"USDT.Ethereum": { precision: 2, depositTime: 2, confirmations: 12 },
	"WLD.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"WLFI.Ethereum": { precision: 18, depositTime: 2, confirmations: 12 },
	"XAUT.Ethereum": { precision: 6, depositTime: 2, confirmations: 12 },
	"LTC.Litecoin": { precision: 8, depositTime: 2, confirmations: 1 },
	"DAI.Polygon": { precision: 8, depositTime: 2, confirmations: 12 },
	"POL.Polygon": { precision: 8, depositTime: 2, confirmations: 12 },
	"SAND.Polygon": { precision: 18, depositTime: 2, confirmations: 12 },
	"USDC.Polygon": { precision: 8, depositTime: 2, confirmations: 12 },
	"USDT.Polygon": { precision: 8, depositTime: 2, confirmations: 12 },
	"TRX.Tron": { precision: 6, depositTime: 1, confirmations: 19 },
	"USD1.Tron": { precision: 18, depositTime: 1, confirmations: 19 },
	"USDD.Tron": { precision: 18, depositTime: 1, confirmations: 19 },
