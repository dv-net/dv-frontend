<script setup lang="ts">
	...
	import BlockLatestTransactions from "@pay-simple/views/payerForm/components/blockLatestTransactions/BlockLatestTransactions.vue";
	import AmountEditor from "@pay-simple/views/payerForm/components/amountEditor/AmountEditor.vue";
