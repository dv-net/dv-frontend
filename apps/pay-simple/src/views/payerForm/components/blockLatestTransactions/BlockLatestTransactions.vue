<script setup lang="ts">
	...
	import type { IWalletTransactionResponse } from "@pay-simple/utils/types/api/apiGo.ts";
	...
	const { transactionsConfirmed, invoiceCurrency } = storeToRefs(usePayerFormStore());
				...
				>
					<div class="header">
						...
						<div class="header__amount">
							{{ formatFiatAmount(item.amount_usd, item.fiat_currency || invoiceCurrency) }}
						</div>
					</div>
