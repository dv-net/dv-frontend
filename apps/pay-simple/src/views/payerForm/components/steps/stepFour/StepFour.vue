<script setup lang="ts">
	...
	import loaderWaitingConfirmation from "@pay-simple/assets/animations/loaderWaitingConfirmation.json";
	...
	import { useTimer } from "@pay-simple/utils/composables/useTimer.ts";
	...
	const AdvertisingBlock = defineAsyncComponent(
		() => import("@pay-simple/views/payerForm/components/steps/stepFour/advertisingBlock/AdvertisingBlock.vue")
	);
