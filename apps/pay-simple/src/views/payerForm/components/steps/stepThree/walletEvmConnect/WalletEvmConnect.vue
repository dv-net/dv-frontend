<script setup lang="ts">
	...
	import {
		...
		wagmiAdapter
	} from "@pay-simple/utils/constants/connectWallet/evm.ts";
	import { UiButton, UiCopyText, UiIcon, UiInput } from "@dv.net/ui-kit";
	import IconWalletConnect from "@pay-simple/components/icons/IconWalletConnect.vue";
	import iconMetaMask from "@pay-simple/assets/images/wallets/metaMask.png";
	import iconTrustWallet from "@pay-simple/assets/images/wallets/trustWallet.png";
	import iconOkxWallet from "@pay-simple/assets/images/wallets/okx.png";
	import iconRabbyWallet from "@pay-simple/assets/images/wallets/rabbyWallet.png";
	import type { IProps } from "@pay-simple/views/payerForm/components/steps/stepThree/walletEvmConnect/IProps.ts";
