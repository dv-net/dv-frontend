<script setup lang="ts">
	...
	import type { ILatestTransaction } from "./types";
				...
				>
					<div class="header">
						...
						<div class="header__amount">
							{{ formatFiatAmount(item.amount_usd, item.fiat_currency || fiatCurrency) }}
						</div>
					</div>
