<script setup lang="ts">
	...
	import iconMetaMask from "@pay-shared/assets/images/wallets/metaMask.png";
	import iconTrustWallet from "@pay-shared/assets/images/wallets/trustWallet.png";
	import iconOkxWallet from "@pay-shared/assets/images/wallets/okx.png";
	import iconRabbyWallet from "@pay-shared/assets/images/wallets/rabbyWallet.png";
	...
	const { chain, recipientAddress, token, amount, addresses } = defineProps<IProps>();
	...
	const tokenInfo = computed(() => {
		...
		return addresses.find((item) => item.currency.id === currencyId)?.currency;
	});
